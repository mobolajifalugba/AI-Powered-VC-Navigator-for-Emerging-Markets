document.getElementById('input-form').addEventListener('submit', function(event) {
    ...
    const MODEL_ENDPOINT_URL = 'log_reg.pkl';
    ...
    .then(data => {
        ...
        if (data.prediction === 1) {
            ...
            alert("Great news! According to the analysis, the model predicts that the startup is positioned for success.   Remember to stay agile and adaptive to capitalize on opportunities and maintain growth.");
        }
    })
    .catch(error => {
